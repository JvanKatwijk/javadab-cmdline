...
//	however, I did not fully understand the semantics of
//	the Device interface and I do not fully
//	understand the rtl_tcp protocol
...
public class RtlTcpDevice implements Device {
	...
	public RtlTcpDevice (String host, int port,
	                     int frequencyHz, int gain, boolean autogain) {
...
//	   this. buffer		= this. connector. getCopyOfBufferedInputstream();
	...
	@Override
	public void restartReader (int frequencyHz) {
